...
public class MatrixRowStats {
   ...
   public static DoubleArrayList matrixRowSsqs(DenseDoubleMatrix2DNamed M) {
      return matrixRowSsqs(M, matrixRowMeans(M));
   }
     ...
     */
    public static DoubleArrayList matrixRowSsqs(DenseDoubleMatrix2DNamed M, DoubleArrayList means) {
      int i;
     ...
     * @return DoubleArrayList
     */
    public static DoubleArrayList matrixRowMeans(DenseDoubleMatrix2DNamed M) {
      int i;
      DoubleArrayList r = new DoubleArrayList(M.rows());
      for (i = 0; i < M.rows(); i++) {
     ...
     * @return DoubleArrayList
     */
    public static DoubleArrayList matrixRowSums(DenseDoubleMatrix2DNamed M) {
      int i;
      DoubleArrayList r = new DoubleArrayList(M.rows());
      for (i = 0; i < M.rows(); i++) {
     ...
     * @return DoubleArrayList
     */
    public static DoubleArrayList matrixRowStdevs(DenseDoubleMatrix2DNamed M) {
      int i;
      DoubleArrayList r = new DoubleArrayList(M.rows());
      for (i = 0; i < M.rows(); i++) {
         r.set(i,
               DescriptiveWithMissing.standardDeviation(DescriptiveWithMissing.variance(DescriptiveWithMissing.
