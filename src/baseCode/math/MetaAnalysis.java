...
/**
 * <p>Title: MetaAnalysis </p>
 * <p>Description: Statistics for meta-analysis </p>
...
public class MetaAnalysis {
     ...
     * @return double
     */
    public static double qTest(DoubleArrayList effectSizes, DoubleArrayList variances, double globalMean) {
      double r = 0.0;
