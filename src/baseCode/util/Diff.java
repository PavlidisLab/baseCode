/*
 * $Log$
 * Revision 1.1  2004/06/21 21:59:31  pavlidis
 ...
 * "ignore whitespace" are implemented by modifying the <code>equals</code>
 * and <code>hashcode</code> methods for the objects compared.
 * <p>
 * The basic algorithm is described in:</br> "An O(ND) Difference Algorithm and
 * its Variations", Eugene Myers, Algorithmica Vol. 1 No. 2, 1986, p 251.
 * <p>
...
public class Diff {
	 ...
	 * <code>equals</code>. The original Object arrays are no longer needed
	 * for computing the differences. They will be needed again later to print
	...
	class file_data {
		...
		/**
		 * Discard lines that have no matches in another file. A line which is
		 * discarded will not be considered by the actual comparison algorithm;
		 * it will be as if that line were not in the file. The file's
		 ...
		 * comparison algorithm produces results that are comprehensible when
