...
public class MissingFilter extends AbstractFilter implements Filter {
     ...
     * (currently 2) that must be present for a row to be kept; but this value
     * is in turn overridden by the maxfractionRemoved.
     * 
     * @param m
     *            int
     */
    ...
    public NamedMatrix filter(NamedMatrix data) {
        ...
        log.info("There are " + kept
                ...
                + minpresent + " values (or fewer than " + ABSOLUTEMINPRESENT
                + ")");
