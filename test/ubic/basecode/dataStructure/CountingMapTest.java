...
public class CountingMapTest {
    ...
    public void testCount() {
        ...
        assertEquals( "count of non-existant key returns 0", map.count( KEY_1 ), 0 );
        map.increment( KEY_1 );
        assertEquals( "count of once-incremented key returns 1", map.count( KEY_1 ), 1 );
        map.increment( KEY_1 );
        assertEquals( "count of twice-incremented key returns 2", map.count( KEY_1 ), 2 );
    }
    ...
    public void testIncrement() {
        CountingMap<String> map = new CountingMap<String>();
        assertEquals( "increment of new key returns 1", map.increment( KEY_1 ), 1 );
        assertEquals( "increment of same key returns 2", map.increment( KEY_1 ), 2 );
    }
    ...
    public void testSeen() {
        CountingMap<String> map = new CountingMap<String>();
        assertEquals( "seen of non-existant key returns false", map.seen( KEY_1 ), false );
        map.increment( KEY_1 );
        assertEquals( "seen of incremented key returns true", map.seen( KEY_1 ), true );
    }
