...
public class TestDescriptiveWithMissing extends TestCase {
   ...
   public void testCovariance() {
      double expectedReturn = Descriptive.covariance( datacortest1Nomissing,
            datacortest2Nomissing );
      double actualReturn = DescriptiveWithMissing.covariance( data1missing,
            data2missing );
      assertEquals( "return value", expectedReturn, actualReturn,
            Double.MIN_VALUE );
   }
   ...
   public void testDurbinWatsonShort() {
      ...
      try {
         ...
         double actualReturn = DescriptiveWithMissing
               .durbinWatson( data3shortmissing );
   ...
   public void testGeometricMean() {
      ...
      assertEquals( "Excercises sumOfLogarithms too; return value",
   ...
   public void testSampleKurtosis() {
      double expectedReturn = Descriptive.sampleKurtosis( data1Nomissing,
            Descriptive.mean( data1Nomissing ), Descriptive.sampleVariance(
                  data1Nomissing, Descriptive.mean( data1Nomissing ) ) );
      double actualReturn = DescriptiveWithMissing.sampleKurtosis(
      ...
      assertEquals( "Exercises sampleVariance, mean as well; return value",
            expectedReturn, actualReturn, Double.MIN_VALUE );
   }
...
//      Descriptive.standardize(data1Nomissing, mean, stdev);
   ...
   public void testVariance() {
      double expectedReturn = Descriptive.variance( data1Nomissing.size(),
            Descriptive.sum( data1Nomissing ), Descriptive
                  .sumOfSquares( data1Nomissing ) );
