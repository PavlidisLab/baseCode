...
public class TestCorrelationEffectMetaAnalysis extends TestCase {
   ...
   protected void setUp() throws Exception {
      ...
      ds3n = new DoubleArrayList( new double[] {
            10, 20, 13, 22, 28, 12, 12, 36, 19, 12, 36, 75, 33, 121, 37, 14,
            40, 16, 14, 20
      } );

      ds3r = new DoubleArrayList( new double[] {
            0.68, 0.56, 0.23, 0.64, 0.49, -0.04, 0.49, 0.33, 0.58, 0.18, -0.11,
