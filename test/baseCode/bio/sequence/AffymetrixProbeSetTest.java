...
public class AffymetrixProbeSetTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        iotest = AffymetrixProbeSetTest.class.getResourceAsStream( "/data/100470_at.probes" );
    }
    ...
    public final void testCollapseTrouble() throws Exception {
        ...
        Map k = apr.read( iotest );
        AffymetrixProbeSet t = ( AffymetrixProbeSet ) k.get( "100470_at" );
